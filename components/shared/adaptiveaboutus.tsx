    ...
    return (
        <>
            ...
            <div className="flex items-center justify-end z-[100] lg:hidden [transition: 0.5s]">
                {isActive ? (
                    <Image className="[transition:1s]" onClick={() => setActive(!isActive)} src={uppbtn} alt="upp"/>
                ) : (
                    <Image className="[transition:3s]" onClick={() => setActive(!isActive)} src={downbutt} alt="down"/>
                )}
