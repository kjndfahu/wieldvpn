...
export const HeaderNavigation: React.FC<Props> =({aboutus, reviews, price, scrollTo, className}) => {
    ...
    return (
        <div className="absolute left-0 right-0 lg:flex lg:z-30 lg:cursor-pointer lg:justify-center lg:items-center lg:gap-10 lg:text-white lg:text-[24px] lg:leading-6 lg:font-normal hidden">
